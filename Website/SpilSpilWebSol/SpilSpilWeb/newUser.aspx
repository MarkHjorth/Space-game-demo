            ...
            <div class="col-sm-6 col-md-12">
                <div class="account-wall">
                    ...
                    <form class="form-newuser" runat="server">
                        ...
                        <asp:TextBox type="password" id="pass" class="form-control center-block" placeholder="Password" required="required" runat="server" oninput="checkPassSafe(this)" />
                        <asp:TextBox type="password" id="confpass" class="form-control center-block" placeholder="Confirm Password" required="required" oninput="checkps(this)" runat="server" />
